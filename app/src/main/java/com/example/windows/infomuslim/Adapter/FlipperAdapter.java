...
public class FlipperAdapter extends BaseAdapter {
    ...
    private ArrayList<HeroesItem> heros;

    public FlipperAdapter(Context mCtx, ArrayList<HeroesItem> heros){
        this.mCtx = mCtx;
        this.heros = heros;
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HeroesItem hero = heros.get(position);
        ...
        Glide.with(mCtx).load(hero.getImageurl()).into(imageView);
        return view;
    }
}
